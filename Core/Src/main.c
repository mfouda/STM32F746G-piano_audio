...
// Keys positions
white[8] = {0,white_w+1, (white_w+1)*2, (white_w+1)*3, (white_w+1)*4, (white_w+1)*5, (white_w+1)*6, (white_w+1)*7};
black[6] = {white[1]-black_w/2, white[2]-black_w/2, white[3]-black_w/2, white[4]-black_w/2, white[5]-black_w/2, white[6]-black_w/2};

// Global information
uint16_t lcd_w = 480, lcd_h = 272;
